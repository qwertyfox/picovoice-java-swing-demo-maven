...
/*
    Copyright Picovoice
    Visit them at picovoice.ai

    Source code from github.com/Picovoice
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Setting the positions of rooms in the panel according to the roles specified in LOCATIONS
        for (String location :
                LOCATIONS) {
        ...
        Picovoice picovoice;
        final String keywordPath = "src/main/resources/jarvis_windows.ppn";
        final String contextPath = "src/main/resources/smart_lighting_windows.rhn";
